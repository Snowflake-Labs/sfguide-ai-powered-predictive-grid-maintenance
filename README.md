...
1. Go to [GitHub Repository](https://github.com/Snowflake-Labs/sfguide-ai-powered-predictive-grid-maintenance)
...
| High Risk Assets | Critical transformer alerts |
| Asset Health | Detailed asset monitoring |
| Cost Avoidance | Financial impact analysis |
| Reliability Metrics | SAIDI/SAIFI tracking |
| Sensor Trends | Real-time data visualization |

### Cortex Agent Capabilities

The Intelligence Agent combines two powerful Snowflake Cortex features:

**Cortex Analyst (Structured Data)** - Converts natural language to SQL queries:
```
"How many high-risk assets do we have?"
"Which manufacturer's transformers have the best health scores?"
"Show me assets due for maintenance in the next 30 days"
"What's the total SAIDI impact if all high-risk assets fail?"
"Compare transformer performance: GE vs Siemens vs ABB"
```

**Cortex Search (Unstructured Data)** - Searches PDF documents and maintenance logs:
```
"Find maintenance logs for transformer T-SS047-001"
"What do the technical manuals say about oil temperature thresholds?"
"Search for maintenance reports mentioning oil leaks"
```

> **Tip:** Test both types of questions to see how the agent seamlessly combines structured analytics with unstructured document search.
