...
-- Grant roles to ACCOUNTADMIN (role hierarchy - makes roles visible)
GRANT ROLE GRID_ADMIN TO ROLE ACCOUNTADMIN;
GRANT ROLE GRID_DATA_ENGINEER TO ROLE ACCOUNTADMIN;
GRANT ROLE GRID_ML_ENGINEER TO ROLE ACCOUNTADMIN;
GRANT ROLE GRID_ANALYST TO ROLE ACCOUNTADMIN;
GRANT ROLE GRID_OPERATOR TO ROLE ACCOUNTADMIN;

-- Grant roles to current user (handled below with identifier syntax)
...
SET deploying_user = (SELECT CURRENT_USER());
